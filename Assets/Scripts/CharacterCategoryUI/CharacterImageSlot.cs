...
public class CharacterImageSlot : MonoBehaviour
{
    ...
    public void Init(int slotNumber)
    {
        ...
        string slot2DImageName = DBManager.Instance.DB.characterSheet[slotNumber].slot2DImageName;
        // Debug.Log($"{slot2DImageName}");
        
        // 캐릭터 슬롯 이미지 가져오기.
        _slotCharacterImage.sprite = Resources.Load<Sprite>($"{Define.Slot2DFolderPath + slot2DImageName}") as Sprite;
    }
}
